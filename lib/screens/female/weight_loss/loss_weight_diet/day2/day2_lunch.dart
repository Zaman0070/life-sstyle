...
class LossLunchDay2 extends StatefulWidget {
  String youm;
  LossLunchDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _LossLunchDay2State createState() => _LossLunchDay2State();
}

class _LossLunchDay2State extends State<LossLunchDay2> {
  @override
