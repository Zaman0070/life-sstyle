...
class LossBfDay2 extends StatefulWidget {
  String youm;
  LossBfDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _LossBfDay2State createState() => _LossBfDay2State();
}

class _LossBfDay2State extends State<LossBfDay2> {
  @override
