...
class LossSnakeDay2 extends StatefulWidget {
  String youm;
  LossSnakeDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _LossSnakeDay2State createState() => _LossSnakeDay2State();
}

class _LossSnakeDay2State extends State<LossSnakeDay2> {
  @override
