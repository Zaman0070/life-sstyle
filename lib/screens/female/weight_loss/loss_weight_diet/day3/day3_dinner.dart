...
class LossDinnerDay3 extends StatefulWidget {
  String youm;
  LossDinnerDay3({required this.youm,Key? key}) : super(key: key);


  @override
  _LossDinnerDay3State createState() => _LossDinnerDay3State();
}

class _LossDinnerDay3State extends State<LossDinnerDay3> {
  @override
