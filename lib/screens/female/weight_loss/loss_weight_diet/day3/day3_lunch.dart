...
class LossLunchDay3 extends StatefulWidget {
  String youm;
  LossLunchDay3({required this.youm,Key? key}) : super(key: key);


  @override
  _LossLunchDay3State createState() => _LossLunchDay3State();
}

class _LossLunchDay3State extends State<LossLunchDay3> {
  @override
