...
import 'menuday3.dart';

class LossSnakeDay3 extends StatefulWidget {
  String youm;
  LossSnakeDay3({required this.youm,Key? key}) : super(key: key);

  @override
  _LossSnakeDay3State createState() => _LossSnakeDay3State();
}

class _LossSnakeDay3State extends State<LossSnakeDay3> {
  @override
