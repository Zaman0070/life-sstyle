...
class LossBFDay1 extends StatefulWidget {
  String youm;
  LossBFDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _LossBFDay1State createState() => _LossBFDay1State();
}

class _LossBFDay1State extends State<LossBFDay1> {
  @override
