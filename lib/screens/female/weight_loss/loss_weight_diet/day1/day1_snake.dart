...
class LossSnakeDay1 extends StatefulWidget {
  String youm;
  LossSnakeDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _LossSnakeDay1State createState() => _LossSnakeDay1State();
}

class _LossSnakeDay1State extends State<LossSnakeDay1> {
  @override
