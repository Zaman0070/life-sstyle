...
class LossDinerDay1 extends StatefulWidget {
  String youm;
  LossDinerDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _LossDinerDay1State createState() => _LossDinerDay1State();
}

class _LossDinerDay1State extends State<LossDinerDay1> {
  @override
