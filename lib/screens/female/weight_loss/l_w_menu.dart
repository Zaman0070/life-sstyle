...
class LossWeightMenu extends StatefulWidget {
  const LossWeightMenu({Key? key}) : super(key: key);

  @override
  _LossWeightMenuState createState() => _LossWeightMenuState();
}

class _LossWeightMenuState extends State<LossWeightMenu> {
  @override
