...
class SnackDay1 extends StatefulWidget {
  String youm;
  SnackDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _SnackDay1State createState() => _SnackDay1State();
}

class _SnackDay1State extends State<SnackDay1> {
  @override
