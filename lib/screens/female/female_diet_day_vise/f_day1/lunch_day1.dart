...
class Lunchday1 extends StatefulWidget {
  String youm;
  Lunchday1({required this.youm,Key? key}) : super(key: key);

  @override
  _Lunchday1State createState() => _Lunchday1State();
}

class _Lunchday1State extends State<Lunchday1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/lunch1.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
