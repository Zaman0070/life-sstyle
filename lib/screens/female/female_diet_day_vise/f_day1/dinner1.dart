...
class Dinnerday1 extends StatefulWidget {
  String youm;
  Dinnerday1({required this.youm,Key? key}) : super(key: key);

  @override
  _Dinnerday1State createState() => _Dinnerday1State();
}

class _Dinnerday1State extends State<Dinnerday1> {
  @override
