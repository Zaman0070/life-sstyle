...
class LunchDay2 extends StatefulWidget {
  String youm;
  LunchDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _LunchDay2State createState() => _LunchDay2State();
}

class _LunchDay2State extends State<LunchDay2> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/lunch2.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('سلطة الدجاج مع شباتي واحد أو اثنين يمكنك أيضًا تناولها مع صلصة النعناع',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
