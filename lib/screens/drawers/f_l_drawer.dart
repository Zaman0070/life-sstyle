...
class FemaleLossDrawer extends StatefulWidget {
  const FemaleLossDrawer({Key? key}) : super(key: key);

  @override
  _FemaleLossDrawerState createState() => _FemaleLossDrawerState();
}

class _FemaleLossDrawerState extends State<FemaleLossDrawer> {
                        ...
                        ListTile(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => LossWeightSportCalender()));
                          },
                          leading: Image.asset(
