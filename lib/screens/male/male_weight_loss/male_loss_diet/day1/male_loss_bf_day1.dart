...
class MaleLossBFDay1 extends StatefulWidget {
  String youm;
  MaleLossBFDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossBFDay1State createState() => _MaleLossBFDay1State();
}

class _MaleLossBFDay1State extends State<MaleLossBFDay1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/lossbf1.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('خبز مع طماطم مع سجق نباتي يمنحك الطاقة الكافية لبدء يومك',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
