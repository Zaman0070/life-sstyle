...
class MaleLossDinerDay1 extends StatefulWidget {
  String youm;
  MaleLossDinerDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossDinerDay1State createState() => _MaleLossDinerDay1State();
}

class _MaleLossDinerDay1State extends State<MaleLossDinerDay1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/lossdiner1.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('قطعتان من السمك تقريبا كل منهما 75 جرام مطبوخة في زيت الزيتون وتناولها مع صلصة النعناع',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
