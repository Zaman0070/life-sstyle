...
class MaleLossSnakeDay1 extends StatefulWidget {
  String youm;
  MaleLossSnakeDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossSnakeDay1State createState() => _MaleLossSnakeDay1State();
}

class _MaleLossSnakeDay1State extends State<MaleLossSnakeDay1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/losssnak1.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('حساء السبانخ النباتي منخفض السعرات الحرارية مثالي ودسم ومليء بالعناصر الغذائية. لا نصف ونصف ، لا زبدة ، لا كريمة حامضة ، فقط بطاطس وكثير من السبانخ.',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
