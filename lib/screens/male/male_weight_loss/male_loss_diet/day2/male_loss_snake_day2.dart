...
class MaleLossSnakeDay2 extends StatefulWidget {
  String youm;
  MaleLossSnakeDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossSnakeDay2State createState() => _MaleLossSnakeDay2State();
}

class _MaleLossSnakeDay2State extends State<MaleLossSnakeDay2> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/losssnak2.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('الدجاج منخفض السعرات الحرارية ولكنه غني بالبروتين وقد يكون مفيدًا بشكل خاص لفقدان الوزن إذا كان هذا هدفًا لك',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
