...
class MaleLossLunchDay2 extends StatefulWidget {
  String youm;
  MaleLossLunchDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossLunchDay2State createState() => _MaleLossLunchDay2State();
}

class _MaleLossLunchDay2State extends State<MaleLossLunchDay2> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/losslunch2.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('تناول برجر لحم بقري قليل الدهن على كعكة من الحبوب الكاملة مع الأفوكادو في الأعلى ولا داعي للقلق.',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
