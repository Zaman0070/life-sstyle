...
class MaleLossDinerDay2 extends StatefulWidget {
  String youm;
  MaleLossDinerDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossDinerDay2State createState() => _MaleLossDinerDay2State();
}

class _MaleLossDinerDay2State extends State<MaleLossDinerDay2> {
  @override
