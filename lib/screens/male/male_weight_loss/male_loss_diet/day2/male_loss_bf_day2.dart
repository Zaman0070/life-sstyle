...
import 'male_loss_food_menu_day2.dart';

class MaleLossBfDay2 extends StatefulWidget {
  String youm;
  MaleLossBfDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossBfDay2State createState() => _MaleLossBfDay2State();
}

class _MaleLossBfDay2State extends State<MaleLossBfDay2> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/lossbf2.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('إنه ذو سعرات حرارية منخفضة يمكن أن يساعدك على إنقاص الوزن بشكل أسرع شرب وعاء من رقائق الذرة مع الحليب في الصباح يبقي معدتك ممتلئة لفترة طويلة',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
