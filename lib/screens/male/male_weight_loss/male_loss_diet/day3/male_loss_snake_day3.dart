...
class MaleLossSnakeDay3 extends StatefulWidget {
  String youm;
  MaleLossSnakeDay3({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossSnakeDay3State createState() => _MaleLossSnakeDay3State();
}

class _MaleLossSnakeDay3State extends State<MaleLossSnakeDay3> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/losssnake3.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('حصة رقائق البطاطس (15 شيبس) حوالي 160 سعرة حرارية و 10 جرامات من الدهون',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
