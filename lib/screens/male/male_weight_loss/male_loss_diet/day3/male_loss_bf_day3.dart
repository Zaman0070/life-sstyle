...
class MaleLossBfDay3 extends StatefulWidget {
  String youm;
  MaleLossBfDay3({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleLossBfDay3State createState() => _MaleLossBfDay3State();
}

class _MaleLossBfDay3State extends State<MaleLossBfDay3> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/loss/lossbf3.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
            ...
            Padding(
              ...
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text('يمكن أن يساعدك سمك السلمون في كثير من الأحيان على إنقاص الوزن وإبقائه بعيدًا مثل الأطعمة الأخرى الغنية بالبروتين ، فهو يساعد على تنظيم الهرمونات التي تتحكم في الشهية وتجعلك تشعر بالشبع.',
                  style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),
                ),
              ),
            )
