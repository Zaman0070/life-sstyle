...
class Male_General_Advices extends StatefulWidget {
  const Male_General_Advices({Key? key}) : super(key: key);

  @override
  _Male_General_AdvicesState createState() => _Male_General_AdvicesState();
}

class _Male_General_AdvicesState extends State<Male_General_Advices> {
  @override
