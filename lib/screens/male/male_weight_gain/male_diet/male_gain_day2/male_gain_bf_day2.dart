...
class MaleGainBFDay2 extends StatefulWidget {
  String youm;
  MaleGainBFDay2({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleGainBFDay2State createState() => _MaleGainBFDay2State();
}

class _MaleGainBFDay2State extends State<MaleGainBFDay2> {
  @override
