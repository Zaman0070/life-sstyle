...
class MaleGainSnakeDay1 extends StatefulWidget {
  String youm;
  MaleGainSnakeDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleGainSnakeDay1State createState() => _MaleGainSnakeDay1State();
}

class _MaleGainSnakeDay1State extends State<MaleGainSnakeDay1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/snake1.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
