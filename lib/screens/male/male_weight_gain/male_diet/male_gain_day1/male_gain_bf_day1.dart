...
class MaleGainBFDay1 extends StatefulWidget {
  String youm;
  MaleGainBFDay1({required this.youm,Key? key}) : super(key: key);

  @override
  _MaleGainBFDay1State createState() => _MaleGainBFDay1State();
}

class _MaleGainBFDay1State extends State<MaleGainBFDay1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              height: 210,
              width: MediaQuery.of(context).size.width,
              child: Image.asset('assets/bf1.jpg',fit: BoxFit.cover,),
            ),
            Container(
              height: 100,
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        SizedBox(height: 15,),
                        Text('خبز بالعسل والبرتقال',
                          style: TextStyle(fontWeight: FontWeight.w500,fontSize: 24,letterSpacing: 1.5),
                        ),
                        Row(
                          children: [
                            Row(
